...
#define CAN_KILL_DINALFOS (CAN_USE_SWORD || CAN_BE_GORON || (HAS_ITEM(ITEM_BOW) ||  (CAN_BE_DEKU && HAS_MAGIC) 
...
#define CAN_KILL_ENEMY(DRAGONFLY) (CAN_BE_DEKU && HAS_MAGIC) || CAN_USE_EXPLOSIVE || HAS_ITEM(ITEM_DEKU_NUT) || CAN_USE_SWORD || CAN_BE_ZORA)
#define CAN_KILL_ENEMY(BOE) (CAN_BE_DEKU && HAS_MAGIC) || CAN_USE_EXPLOSIVE || HAS_ITEM(ITEM_DEKU_NUT) || CAN_USE_SWORD || CAN_BE_ZORA || CAN_BE_GORON)
#define CAN_KILL_ENEMY(SNAPPER) (CAN_BE_DEKU || CAN_USE_EXPLOSIVE || CAN_BE_GORON),
#define CAN_KILL_ENEMY(SKULLTULA) (CAN_USE_SWORD || CAN_USE_PROJECTILE || CAN_BE_GORON || CAN_USE_EXPLOSIVES)
#define CAN_KILL_BAT \
